...
public:
    ...
    // pre:
    // post: substracts the value of b from the value
    //       of this biguint
    //       (and sets to 0 if the result is negative)
    //        this is the MINUS operation
    void operator -= (const biguint &b);
    ...
    // pre:
    // post: returns true if this biguint is prime, false otherwise
    bool isPrime();
    ...
    // pre:
    // post: returns the string representation of this biguint without leading zeroes
